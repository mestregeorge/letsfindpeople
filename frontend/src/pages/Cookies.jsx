  ...
  return (
    <div className="policy-page container py-5">
      ...
      <div className="policy-content">
        ...
        <ul>
          <li>
            <strong>Authentication cookies:</strong> keep you logged in during
            your session so you do not need to re-enter your credentials on
            every page.
          </li>
          <li>
            <strong>Security cookies:</strong> help detect and prevent abuse,
            fraud, and unauthorised automated access.
          </li>
          <li>
        ...
        <p>
          ...
          that disabling essential cookies will prevent the Service from
          functioning correctly. Most browsers allow you to:
        </p>
        <ul>
        ...
        <p>For guidance, visit your browser&apos;s help documentation.</p>

        <h4>5. Changes to This Policy</h4>
        <p>
          We may update this Cookies Policy as our use of cookies changes. The
