    ...
    <div className="policy-page container py-5">
      ...
      <div className="policy-content">
        ...
        <p>
          ...
          and use of the LetsFindPeople website and Service. By registering or
        ...
        <p>
          You agree to use the Service only for lawful, personal, non-commercial
          purposes. You must not:
        </p>
        <ul>
          <li>
            Use automated tools, bots, scrapers, API grabbers, crawlers, or any
            other automated means to access, collect, or extract data from the
            Service without express written permission.
          </li>
          <li>
            Access or attempt to access any user data without going through the
            normal login and search flow of the Service.
          </li>
          <li>
            Perform searches in rapid succession or in excessive volume within a
            short period of time (search spam). Violations may result in
